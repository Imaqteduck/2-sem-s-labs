...
public class LinkedQ<Item> implements Iterable<Item> {
    private int n;
    private int size;
    private Node first;
    private Node last;

    public LinkedQ(int size) {
        n = 0;
        this.size = size;
    }

    private class LinkedQIterator implements Iterator<Item> {
        Node node = first;
